...
# D13 On which day of week was the biggest sales order made? What was the product? 
...
/***********************************Conclusion about YoY Performance***************************************/
 /*
...
-- The total sales, total quantity of items ordered, and total number of orders placed YoY also generally decreased. 
...
-- Although total sales, total quantity of items ordered and total orders increased from 2011 to 2012, the shipping costs also
   increased while profit decreased, so that increase is marginal. 
